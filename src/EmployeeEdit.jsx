            ...
            <Card.Body>
                <Card.Text>
                    <Container fluid>
                        ...
                        <Button type="submit" variant="primary" size="small" className="my-3">Update Employee</Button>
                        <Alert variant={this.state.alertColor} show={this.state.alertVisible} dismissible onClose={()=>{this.setState({alertVisible: false})}}>{this.state.alertMessage}</Alert>
                        </form>
                    </Container>
